(() => {
  try {
    ...
    const stateKey = () => `monecole_v105_planning_${schoolSlug()}`;
    const permissionKey = () => `monecole_v105_timetable_policy_${schoolSlug()}`;
    const defaultState = () => ({
      active: "planning",
    ...
    const legacyState = () => read(`monecole_v104_planning_${schoolSlug()}`, read(`monecole_v103_planning_${schoolSlug()}`, read(`monecole_v102_planning_${schoolSlug()}`, read(`monecole_v101_planning_${schoolSlug()}`, null))));
      ...
      zone.innerHTML = `
        <div class="me-v101-print-header">
          ...
          <div class="me-v101-print-meta">
            ...
            <div>Année scolaire : ${escapeHtml(schoolYearLabel())}</div>
    ...
    const renderPlanningPanel = state => {
      ...
      const allCourses = coursesForClass(state);
      ...
      return `
        ...
        <div class="me-v101-filterbar">
          <div>
            ...
            <span>${isTeacher ? "Par défaut, seuls vos cours et matières apparaissent." : "Vue complète de la classe sélectionnée."}</span>
          </div>
        ...
        <section class="me-v101-card">
          ...
          <p>${isTeacher && state.timetableScope !== "all" ? `${courses.length} cours affiché(s) sur ${allCourses.length} pour votre compte.` : "Ajoutez les cours avec les suggestions automatiques de classes, matières et professeurs déjà enregistrés."}</p>
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v105-subjects" data-course-subject value="${escapeHtml(editing?.subject || "")}" placeholder="Ex : Mathématiques"></div>
            <div class="me-v101-field"><label>Professeur</label><input list="me-v105-professors" data-course-professor value="${escapeHtml(editing?.professor || defaultProfessor)}" placeholder="Nom du professeur"></div>
    ...
    const renderSweepPanel = state => {
      ...
      return `
        <section class="me-v101-card">
          ...
          <p>Organisez les élèves de service par jour. Les noms enregistrés dans l’école sont proposés automatiquement pendant la saisie.</p>
            ...
            <article class="me-v101-day" data-sweep-day="${day}">
              ...
              <div class="me-v101-day-body">
                <div class="me-v101-form" style="grid-template-columns:minmax(0,1fr) auto">
                  <div class="me-v101-field"><label>Élève</label><input list="me-v105-students" data-sweep-name placeholder="Nom ou prénom"></div>
    ...
    const renderSubjectsPanel = state => {
      ...
      return `
        <section class="me-v101-card">
          ...
          <p>Chaque professeur prépare, modifie, imprime et conserve ses propres sujets. Les matières liées au compte sont proposées automatiquement.</p>
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v105-subjects" data-subject-matter value="${escapeHtml(editing?.matter || "")}" placeholder="Ex : Sciences"></div>
            ...
            <div class="me-v101-field"><label>Date</label><input data-subject-date type="date" value="${escapeHtml(editing?.date || "")}"></div>
    ...
    const renderApp = root => {
      ...
      root.innerHTML = `
        <section class="me-v101-planning-page">
          <datalist id="me-v105-classes">${optionsHtml(classes)}</datalist>
          <datalist id="me-v105-subjects">${optionsHtml(catalog.subjects)}</datalist>
          <datalist id="me-v105-professors">${optionsHtml(catalog.professors)}</datalist>
          <datalist id="me-v105-students">${optionsHtml(catalog.students)}</datalist>
          <div class="me-v101-head">
            <div class="me-v101-title">
              <h1>Planning & outils pédagogiques</h1>
              <p>Gérez séparément l’emploi du temps, le cahier de texte, la liste de balayage et la préparation des sujets.</p>
            </div>
          </div>
    ...
    console.warn("MonEcole planning v105", error);
  }
})();
