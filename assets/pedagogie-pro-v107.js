(() => {
  try {
    ...
    const stateKey = () => `monecole_v107_planning_${schoolSlug()}`;
    const permissionKey = () => `monecole_v107_timetable_policy_${schoolSlug()}`;
    const defaultState = () => ({
      active: "planning",
    ...
    const legacyState = () => read(`monecole_v106_planning_${schoolSlug()}`, read(`monecole_v105_planning_${schoolSlug()}`, read(`monecole_v104_planning_${schoolSlug()}`, read(`monecole_v103_planning_${schoolSlug()}`, read(`monecole_v102_planning_${schoolSlug()}`, read(`monecole_v101_planning_${schoolSlug()}`, null))))));
      ...
      return `
        ...
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v107-subjects" data-course-subject value="${escapeHtml(editing?.subject || "")}" placeholder="Ex : Mathématiques"></div>
            <div class="me-v101-field"><label>Professeur</label><input list="me-v107-professors" data-course-professor value="${escapeHtml(editing?.professor || defaultProfessor)}" placeholder="Nom du professeur"></div>
            ...
            <article class="me-v101-day" data-sweep-day="${day}">
              ...
              <div class="me-v101-day-body">
                <div class="me-v101-form" style="grid-template-columns:minmax(0,1fr) auto">
                  <div class="me-v101-field"><label>Élève</label><input list="me-v107-students" data-sweep-name placeholder="Nom ou prénom"></div>
      ...
      return `
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v107-subjects" data-subject-matter value="${escapeHtml(editing?.matter || "")}" placeholder="Ex : Sciences"></div>
    ...
    const renderApp = root => {
      ...
      root.innerHTML = `
        <section class="me-v101-planning-page">
          <datalist id="me-v107-classes">${optionsHtml(classes)}</datalist>
          <datalist id="me-v107-subjects">${optionsHtml(catalog.subjects)}</datalist>
          <datalist id="me-v107-professors">${optionsHtml(catalog.professors)}</datalist>
          <datalist id="me-v107-students">${optionsHtml(catalog.students)}</datalist>
    ...
    console.warn("MonEcole planning v107", error);
  }
})();
