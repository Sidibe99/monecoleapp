(() => {
  try {
    ...
    const stateKey = () => `monecole_v102_planning_${schoolSlug()}`;
    const permissionKey = () => `monecole_v102_timetable_policy_${schoolSlug()}`;
    const defaultState = () => ({
      active: "planning",
      ...
      const visit = value => {
        ...
        Object.entries(value).forEach(([key, child]) => {
          ...
          if (typeof child === "string") {
            if (/classe/.test(k)) addChoice(classes, child);
      ...
      return `
        ...
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            <div class="me-v101-field"><label>Classe</label><input list="me-v102-classes" data-course-class value="${escapeHtml(editing?.className || state.selectedClass)}" placeholder="Ex : 6e A"></div>
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v102-subjects" data-course-subject value="${escapeHtml(editing?.subject || "")}" placeholder="Ex : Mathématiques"></div>
            <div class="me-v101-field"><label>Professeur</label><input list="me-v102-professors" data-course-professor value="${escapeHtml(editing?.professor || defaultProfessor)}" placeholder="Nom du professeur"></div>
            ...
            <article class="me-v101-day" data-sweep-day="${day}">
              ...
              <div class="me-v101-day-body">
                <div class="me-v101-form" style="grid-template-columns:minmax(0,1fr) auto">
                  <div class="me-v101-field"><label>Élève</label><input list="me-v102-students" data-sweep-name placeholder="Nom ou prénom"></div>
      ...
      return `
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v102-subjects" data-subject-matter value="${escapeHtml(editing?.matter || "")}" placeholder="Ex : Sciences"></div>
    ...
    const renderApp = root => {
      ...
      root.innerHTML = `
        <section class="me-v101-planning-page">
          <datalist id="me-v102-classes">${optionsHtml(classes)}</datalist>
          <datalist id="me-v102-subjects">${optionsHtml(catalog.subjects)}</datalist>
          <datalist id="me-v102-professors">${optionsHtml(catalog.professors)}</datalist>
          <datalist id="me-v102-students">${optionsHtml(catalog.students)}</datalist>
          ...
          <section class="me-v101-card">
            <div class="me-v101-form">
              <div class="me-v101-field">
                ...
                <input list="me-v102-classes" data-selected-class value="${escapeHtml(state.selectedClass)}" placeholder="Ex : 6e A">
              </div>
              <div class="me-v101-field">
    ...
    console.warn("MonEcole planning v102", error);
  }
})();
