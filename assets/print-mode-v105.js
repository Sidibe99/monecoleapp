(() => {
  if (window.__ME_PRINT_MODE_V105__) return;
  window.__ME_PRINT_MODE_V105__ = true;

  const STORAGE_KEY = "me_print_mode";
  const STYLE_ID = "me-print-mode-v105-style";
  const UI_STYLE_ID = "me-print-mode-v105-ui-style";
  const MODAL_ID = "me-print-mode-v105-modal";
  ...
  function installPrintHooksIn(win) {
    try {
      if (!win || win.__ME_PRINT_MODE_CHILD_V105__) return;
      win.__ME_PRINT_MODE_CHILD_V105__ = true;
      const doc = win.document;
      applyPrintMode(doc, state.armedMode || getLastMode());

      if (doc && doc.write && !doc.__ME_PRINT_WRITE_PATCHED_V105__) {
        ...
        doc.__ME_PRINT_WRITE_PATCHED_V105__ = true;
      }

      if (win.print && !win.__ME_PRINT_FUNCTION_PATCHED_V105__) {
        ...
        win.__ME_PRINT_FUNCTION_PATCHED_V105__ = true;
      }
    } catch (_) {}
  }
