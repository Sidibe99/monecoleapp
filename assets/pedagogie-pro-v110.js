(() => {
  try {
    ...
    const stateKey = () => `monecole_v110_planning_${schoolSlug()}`;
    const permissionKey = () => `monecole_v110_timetable_policy_${schoolSlug()}`;
    const defaultState = () => ({
      active: "planning",
      ...
      return `
        ...
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v110-subjects" data-course-subject value="${escapeHtml(editing?.subject || "")}" placeholder="Ex : Mathématiques"></div>
            <div class="me-v101-field"><label>Professeur</label><input list="me-v110-professors" data-course-professor value="${escapeHtml(editing?.professor || defaultProfessor)}" placeholder="Nom du professeur"></div>
            ...
            <article class="me-v101-day" data-sweep-day="${day}">
              ...
              <div class="me-v101-day-body">
                <div class="me-v101-form" style="grid-template-columns:minmax(0,1fr) auto">
                  <div class="me-v101-field"><label>Élève</label><input list="me-v110-students" data-sweep-name placeholder="Nom ou prénom"></div>
      ...
      return `
        <section class="me-v101-card">
          ...
          <div class="me-v101-form">
            ...
            <div class="me-v101-field"><label>Matière</label><input list="me-v110-subjects" data-subject-matter value="${escapeHtml(editing?.matter || "")}" placeholder="Ex : Sciences"></div>
    ...
    const renderApp = root => {
      ...
      root.innerHTML = `
        <section class="me-v101-planning-page">
          <datalist id="me-v110-classes">${optionsHtml(classes)}</datalist>
          <datalist id="me-v110-subjects">${optionsHtml(catalog.subjects)}</datalist>
          <datalist id="me-v110-professors">${optionsHtml(catalog.professors)}</datalist>
          <datalist id="me-v110-students">${optionsHtml(catalog.students)}</datalist>
    ...
    console.warn("MonEcole planning v110", error);
  }
})();
